...
public class MovieHistory extends Activity implements
	...
	private void initData() {
		unitBean = DbData.getUnitBeanByTitleAndEpisode(PersonHistory.historyBean.getTitle(),Integer.parseInt(PersonHistory.historyBean.getEpisode()));
	...
	private void initView() {
		...
		// 对话框
		progressDialog = new ProgressDialog(MovieHistory.this);
	...
	public void onPrepared(MediaPlayer mediaplayer) {
		mMediaPlayer.seekTo(Integer.parseInt(PersonHistory.historyBean.getTime()));
	...
	private void error() {
		Toast.makeText(MovieHistory.this, "视频加载错误,请检查网络", Toast.LENGTH_LONG)
				.show();
	...
	protected void onPause() {
		...
		if (mIsVideoPlay == true && mIsCompletion == false && mMediaPlayer != null) {
			...
			HistoryBean historyBean = PersonHistory.historyBean;
			historyBean.setTime(position + "");
			DbData.writeHistory(historyBean);
		}
		if (mIsCompletion == true) {
			DbData.deleteHistory(PersonHistory.historyBean);
		}
