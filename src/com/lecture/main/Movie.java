...
public class Movie extends Activity implements OnBufferingUpdateListener,
		OnCompletionListener, OnPreparedListener, OnVideoSizeChangedListener,
		SurfaceHolder.Callback, MediaPlayerControl, OnErrorListener,
		OnInfoListener {
	// 数据
	...
	private void initData() {
		int episode = Integer.parseInt(getIntent().getStringExtra(MovieIntro.EPISODE_KEY));
		unitBean = DbData.getUnitBeanByTitleAndEpisode(MovieIntro.programBean.getName(), episode);
	...
	private void initView() {
		...
		controller = new MyMediaController(this,unitBean, Urls);
		progressDialog = new ProgressDialog(Movie.this);
	...
	private void error() {
		Toast.makeText(Movie.this, "视频加载错误,请检查网络", Toast.LENGTH_LONG).show();
	...
	protected void onDestroy() {
		super.onDestroy();
		if (mIsVideoPlay == true && mIsCompletion == false
				&& mMediaPlayer != null) {
			position = (int) mMediaPlayer.getCurrentPosition();
			HistoryBean historyBean = new HistoryBean();
			historyBean.setId(MovieIntro.programBean.getId());
			historyBean.setTitle(MovieIntro.programBean.getName());
			historyBean.setNum(MovieIntro.programBean.getNum() + "");
			historyBean.setAuthor(MovieIntro.programBean.getAuthor());
